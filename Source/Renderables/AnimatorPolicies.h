...
namespace Enigma::Renderables
{
    ...
    {
    public:
        ModelAnimatorPolicy() : m_ruid(Frameworks::Ruid::generate()), m_assetFactory(Animators::Animator::TYPE_RTTI.getName()) {}
        ModelAnimatorPolicy(const std::shared_ptr<Renderables::ModelPrimitive>& controlled, const std::shared_ptr<AnimationAssetPolicy>& asset_policy)
            : m_ruid(Frameworks::Ruid::generate()), m_assetFactory(Animators::Animator::TYPE_RTTI.getName()),
