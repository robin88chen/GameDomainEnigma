...
Triangle3::Triangle3(const Vector3& vec0, const Vector3& vec1, const Vector3& vec2)
{
    m_vec[0] = vec0;
    m_vec[1] = vec1;
    m_vec[2] = vec2;
...
Triangle3::Triangle3(const Vector3 vec[3])
{
    m_vec[0] = vec[0];
    m_vec[1] = vec[1];
    m_vec[2] = vec[2];
...
{
    Vector3 diff = m_vec[0] - vec;
    Vector3 edge0 = m_vec[1] - m_vec[0], edge1 = m_vec[2] - m_vec[0];
