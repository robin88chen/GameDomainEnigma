...
namespace Enigma::WorldMap
{
    ...
    protected:
        ...
        std::shared_ptr<SceneGraph::HydratedLazyNodeAssembler> assembleChildTreeNode(const SceneGraph::SpatialId& parent_id, const Engine::FactoryDesc& parent_desc, const SceneGraph::SpatialId& id, const MathLib::Matrix4& local_transform, const MathLib::Matrix4& world_transform, const Engine::BoundingVolume& model_bound);
