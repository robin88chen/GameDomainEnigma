/*********************************************************************
 * \file   GeometryErrors.h
 * \brief
 *
 * \author Lancelot 'Robin' Chen
 * \date   December 2023
 *********************************************************************/
#ifndef GEOMETRY_ERRORS_H
#define GEOMETRY_ERRORS_H
...
namespace Enigma::Geometries
{
    enum class ErrorCode
    {
        ...
        geometryFactoryNotExists = 101,
        geometryEntityAlreadyExists,

        invalidArrayIndex = 201,
        nullMemoryBuffer,
        zeroVertexSize,
    };
...
namespace std
{
    ...
    template <>
    struct is_error_code_enum<Enigma::Geometries::ErrorCode> : true_type {};
}


#endif // GEOMETRY_ERRORS_H
