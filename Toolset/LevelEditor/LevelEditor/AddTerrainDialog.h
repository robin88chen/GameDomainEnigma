...
namespace LevelEditor
{
    ...
    {
    public:
        AddTerrainDialog(nana::window owner, const std::shared_ptr<TerrainEditConsole>& terrain_edit, const Enigma::SceneGraph::SpatialId& owner_node_id);
    ...
    private:
        ...
        Enigma::SceneGraph::SpatialId m_ownerNodeId;
    };
}
