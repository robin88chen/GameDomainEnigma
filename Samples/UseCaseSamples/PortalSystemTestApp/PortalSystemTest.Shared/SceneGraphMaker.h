...
public:
    ...
    static Enigma::Engine::GenericDto makeSceneGraph(const Enigma::SceneGraph::SpatialId& root_id, const Enigma::SceneGraph::PortalZoneNodeAssembler& outside_region, const Enigma::SceneGraph::SpatialId& portal_id, const Enigma::SceneGraph::PortalZoneNodeAssembler& inside_zone);
};
