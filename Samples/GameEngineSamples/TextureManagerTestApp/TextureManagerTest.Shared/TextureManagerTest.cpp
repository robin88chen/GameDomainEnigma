...
TextureManagerTest::TextureManagerTest(const std::string app_name) : AppDelegate(app_name)
{
...
void TextureManagerTest::InitializeMountPaths()
{
...
void TextureManagerTest::InstallEngine()
{
...
void TextureManagerTest::ShutdownEngine()
{
    delete m_gateway;
    m_gateway = nullptr;
    delete m_timer;
...
void TextureManagerTest::FrameUpdate()
{
...
void TextureManagerTest::RenderFrame()
{
...
void TextureManagerTest::OnRenderTargetCreated(const IEventPtr& e)
{
    if (!e) return;
...
void TextureManagerTest::OnEffectMaterialCompiled(const IEventPtr& e)
{
    if (!e) return;
...
void TextureManagerTest::OnCompileEffectFailed(const IEventPtr& e)
{
    if (!e) return;
...
void TextureManagerTest::OnRenderBufferBuilt(const Enigma::Frameworks::IEventPtr& e)
{
    if (!e) return;
...
void TextureManagerTest::OnBuildRenderBufferFailed(const Enigma::Frameworks::IEventPtr& e)
{
    if (!e) return;
...
void TextureManagerTest::OnTextureLoaded(const IEventPtr& e)
{
    if (!e) return;
...
void TextureManagerTest::OnLoadTextureFailed(const Enigma::Frameworks::IEventPtr& e)
{
    if (!e) return;
...
void TextureManagerTest::BuildVariables()
{
