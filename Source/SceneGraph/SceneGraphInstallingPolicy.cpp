...
#include "Light.h"
#include "SceneGraphCreationMethods.h"
#include <cassert>
...
error SceneGraphInstallingPolicy::install(Frameworks::ServiceManager* service_manager)
{
    ...
    scene_graph_repository->registerSpatialLightFactory(Light::TYPE_RTTI.getName(), LightCreationMethod::create, LightCreationMethod::constitute);
