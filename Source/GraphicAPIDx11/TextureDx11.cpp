...
error TextureDx11::createFromSystemMemory(const MathLib::Dimension<unsigned>& dimension, const byte_buffer& buff)
{
    ...
    {
        Frameworks::EventPublisher::enqueue(std::make_shared<Graphics::TextureResourceCreateFromMemoryFailed>(
    ...
    Frameworks::EventPublisher::enqueue(std::make_shared<Graphics::TextureResourceFromMemoryCreated>(m_name));
    return ErrorCode::ok;
}
...
error TextureDx11::loadTextureImage(const byte_buffer& img_buff)
{
    ...
    if (FATAL_LOG_EXPR(!device))
    {
        Frameworks::EventPublisher::enqueue(std::make_shared<Graphics::TextureResourceLoadImageFailed>(
            m_name, ErrorCode::d3dDeviceNullPointer));
        return ErrorCode::d3dDeviceNullPointer;
    }
    ...
    Frameworks::EventPublisher::enqueue(std::make_shared<Graphics::TextureResourceImageLoaded>(m_name));
    return ErrorCode::ok;
}
...
error TextureDx11::retrieveTextureImage(const MathLib::Rect& rcSrc)
{
    ...
    if (FATAL_LOG_EXPR(!device))
    {
        Frameworks::EventPublisher::enqueue(std::make_shared<Graphics::TextureResourceRetrieveImageFailed>(
            m_name, ErrorCode::d3dDeviceNullPointer));
        return ErrorCode::d3dDeviceNullPointer;
    }
    ...
    Frameworks::EventPublisher::enqueue(std::make_shared<Graphics::TextureResourceImageRetrieved>(shared_from_this(), m_name, rcSrc));
    return ErrorCode::ok;
}
...
error TextureDx11::updateTextureImage(const MathLib::Rect& rcDest, const byte_buffer& img_buff)
{
    ...
    {
        Frameworks::EventPublisher::enqueue(std::make_shared<Graphics::TextureResourceUpdateImageFailed>(
    ...
    Frameworks::EventPublisher::enqueue(std::make_shared<Graphics::TextureResourceImageUpdated>(shared_from_this(), m_name, rcDest));
    return ErrorCode::ok;
}
...
error TextureDx11::saveTextureImage(const FileSystem::IFilePtr& file)
{
    ...
    if (FATAL_LOG_EXPR(!device))
    {
        Frameworks::EventPublisher::enqueue(std::make_shared<Graphics::TextureResourceSaveImageFailed>(
            m_name, ErrorCode::d3dDeviceNullPointer));
        return ErrorCode::d3dDeviceNullPointer;
    }
    ID3D11DeviceContext* deviceContext = api_dx11->GetD3DDeviceContext();
    ...
    Frameworks::EventPublisher::enqueue(std::make_shared<Graphics::TextureResourceImageSaved>(m_name, file->getFullPath()));
    return ErrorCode::ok;
}
...
error TextureDx11::useAsBackSurface(const std::shared_ptr<Graphics::IBackSurface>& back_surf, const std::vector<Graphics::RenderTextureUsage>&)
{
    ...
    if (FATAL_LOG_EXPR(!device))
    {
        Frameworks::EventPublisher::enqueue(std::make_shared<Graphics::TextureResourceUseAsBackSurfaceFailed>(
            m_name, ErrorCode::d3dDeviceNullPointer));
        return ErrorCode::d3dDeviceNullPointer;
    }
    ...
    Frameworks::EventPublisher::enqueue(std::make_shared<Graphics::TextureResourceAsBackSurfaceUsed>(
