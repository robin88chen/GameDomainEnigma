...
CascadeShadowMapTest::CascadeShadowMapTest(const std::string app_name) : AppDelegate(app_name)
{
}

CascadeShadowMapTest::~CascadeShadowMapTest()
{
}

void CascadeShadowMapTest::initializeMountPaths()
{
...
void CascadeShadowMapTest::installEngine()
{
...
void CascadeShadowMapTest::shutdownEngine()
{
    m_sceneRoot = nullptr;
    m_floor = nullptr;
    m_cube = nullptr;
...
void CascadeShadowMapTest::frameUpdate()
{
...
void CascadeShadowMapTest::renderFrame()
{
...
void CascadeShadowMapTest::onSceneGraphRootCreated(const Enigma::Frameworks::IEventPtr& e)
{
    if (!e) return;
...
void CascadeShadowMapTest::onSceneGraphBuilt(const Enigma::Frameworks::IEventPtr& e)
{
    if (!e) return;
...
void CascadeShadowMapTest::onPawnPrimitiveBuilt(const Enigma::Frameworks::IEventPtr& e)
{
    if (!e) return;
    ...
    if (ev->pawn() == m_floor)
    {
        ev->pawn()->getPrimitive()->selectVisualTechnique("CSMReceiver");
    }
    else
    {
...
void CascadeShadowMapTest::createFloorReceiver()
{
...
void CascadeShadowMapTest::createCubePawn()
{
