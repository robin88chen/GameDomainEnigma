/*********************************************************************
 * \file   DrawPrimitiveWithTextureApp_Jni.h
 * \brief  
 * 
 * \author Lancelot 'Robin' Chen
 * \date   August 2022
 *********************************************************************/
#ifndef DRAW_PRIMITIVE_WITH_TEXTURE_APP_JNI_H
#define DRAW_PRIMITIVE_WITH_TEXTURE_APP_JNI_H
...
{
public:
    static inline std::string AndroidAssetPathName = "APK_PATH";
...
#endif // DRAW_PRIMITIVE_WITH_TEXTURE_APP_JNI_H
