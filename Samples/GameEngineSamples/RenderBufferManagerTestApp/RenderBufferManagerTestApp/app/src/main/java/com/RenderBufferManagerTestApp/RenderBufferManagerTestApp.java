...
package com.RenderBufferManagerTestApp;
import android.os.Bundle;
import lib.bridge.enigma.ApplicationBridgeActivity;

public class RenderBufferManagerTestApp extends ApplicationBridgeActivity
{
     ...
     */
    static {
        System.loadLibrary("RenderBufferManagerTest_Jni");
    }
}
