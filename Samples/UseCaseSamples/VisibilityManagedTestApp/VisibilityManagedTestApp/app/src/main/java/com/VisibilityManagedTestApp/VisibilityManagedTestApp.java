...
package com.VisibilityManagedTestApp;
import android.os.Bundle;
import lib.bridge.enigma.ApplicationBridgeActivity;

public class VisibilityManagedTestApp extends ApplicationBridgeActivity
{
    ...
    static {
        System.loadLibrary("VisibilityManagedTest_Jni");
    }
}
