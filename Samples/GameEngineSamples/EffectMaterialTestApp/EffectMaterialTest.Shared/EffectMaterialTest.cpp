...
EffectMaterialTest::EffectMaterialTest(const std::string app_name) : AppDelegate(app_name)
{
    m_material = nullptr;
}

EffectMaterialTest::~EffectMaterialTest()
{
	
}

void EffectMaterialTest::InitializeMountPaths()
{
...
void EffectMaterialTest::InstallEngine()
{
    ...
    m_compiler->CompileEffect(MakeEffectCompilingPolicy());
...
void EffectMaterialTest::ShutdownEngine()
{
    delete m_compiler;
    m_compiler = nullptr;
...
void EffectMaterialTest::FrameUpdate()
{
...
void EffectMaterialTest::RenderFrame()
{
...
EffectCompilingPolicy EffectMaterialTest::MakeEffectCompilingPolicy()
{
...
void EffectMaterialTest::OnRenderTargetCreated(const IEventPtr& e)
{
    if (!e) return;
...
void EffectMaterialTest::OnEffectMaterialCompiled(const IEventPtr& e)
{
    if (!e) return;
...
void EffectMaterialTest::OnEffectCompileFailed(const IEventPtr& e)
{
    if (!e) return;
...
void EffectMaterialTest::OnVertexBufferBuilt(const IEventPtr& e)
{
    if (!e) return;
...
void EffectMaterialTest::OnIndexBufferBuilt(const IEventPtr& e)
{
    if (!e) return;
...
void EffectMaterialTest::OnTextureLoaded(const IEventPtr& e)
{
    if (!e) return;
...
void EffectMaterialTest::BuildVariables()
{
