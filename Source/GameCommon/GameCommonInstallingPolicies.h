...
namespace Enigma::GameCommon
{
    ...
    {
    public:
        GameSceneInstallingPolicy(const SceneGraph::SpatialId& scene_root_id, const std::optional<std::string>& portal_managed_name)
            : m_sceneRootId(scene_root_id), m_portalManagedName(portal_managed_name) {}
