...
namespace Enigma::Graphics
{
    ...
    public:
        IVertexDeclaration(const std::string& data_vertex_format);
        ...
        std::string& GetFormatString() { return m_formatString; };

        const VertexFormatCode& GetVertexFormatCode() const { return m_dataVertexFormatCode; };

        /** is vertex format matched? */
        virtual bool IsMatched(const std::string& data_vertex_format, IVertexShader* vtx_shader) = 0;
