...
package com.EffectJsonGatewayTestApp;
import android.os.Bundle;
import lib.bridge.enigma.ApplicationBridgeActivity;

public class EffectJsonGatewayTestApp extends ApplicationBridgeActivity
{
     ...
     */
    static {
        System.loadLibrary("EffectJsonGatewayTest_Jni");
    }
}
