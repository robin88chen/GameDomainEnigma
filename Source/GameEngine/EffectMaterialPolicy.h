...
namespace Enigma::Engine
{
    ...
    public:
        ...
        [[nodiscard]] const std::optional<EffectCompilingProfile>& GetProfile() const { return m_profile; }

        [[nodiscard]] const std::string& Parameter() const { return m_parameter; }
        [[nodiscard]] const std::shared_ptr<IEffectCompilingProfileDeserializer>& GetDeserializer() const { return m_deserializer; }
